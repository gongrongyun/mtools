...
running command...
$ mycli (--version)
mycli/0.0.0 darwin-x64 node-v16.13.2
$ mycli --help [COMMAND]
USAGE
  $ mycli COMMAND
...
...
_See code: [dist/commands/hello/index.ts](https://github.com/cli/hello-world/blob/v0.0.0/dist/commands/hello/index.ts)_
